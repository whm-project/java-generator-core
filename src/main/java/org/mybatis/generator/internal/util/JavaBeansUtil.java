...
import org.mybatis.generator.internal.QueryModelCommentGenerator;
...
public class JavaBeansUtil {
     ...
     * @return the java beans field
     */
    public static Field getJavaQueryBeansField(IntrospectedColumn introspectedColumn,
                                          Context context,
                                          IntrospectedTable introspectedTable) {
        FullyQualifiedJavaType fqjt = introspectedColumn
                .getFullyQualifiedJavaType();
        ...
        field.setType(fqjt);
        field.setName(property);
        QueryModelCommentGenerator commentGenerator = new QueryModelCommentGenerator();
