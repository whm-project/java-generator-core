...
//        calculateJavaQueryModelGenerators(warnings, progressCallback);
    ...
    public void calculateQueryModelGenerators(List<String> warnings,
                                    ProgressCallback progressCallback) {
        calculateJavaQueryModelGenerators(warnings, progressCallback);
    }
    ...
    protected void calculateJavaQueryModelGenerators(List<String> warnings,
                                             ProgressCallback progressCallback) {
//        if (getRules().generateBaseRecordClass()) {
            AbstractJavaGenerator javaGenerator = new QueryModelGenerator();
            initializeAbstractGenerator(javaGenerator, warnings,
                    progressCallback);
            javaQueryModelGenerators.add(javaGenerator);
//        }
     ...
     */
    public List<GeneratedJavaFile> getQueryModelGeneratedJavaFiles(){
        ...
        for (AbstractJavaGenerator javaGenerator : javaQueryModelGenerators) {
            ...
            for (CompilationUnit compilationUnit : compilationUnits) {
                GeneratedJavaFile gjf = new GeneratedJavaFile(compilationUnit,
                        context.getJavaQueryModelGeneratorConfiguration()
                                .getTargetProject(),
    ...
    public int getGenerationSteps() {
        return  javaQueryModelGenerators.size()+
