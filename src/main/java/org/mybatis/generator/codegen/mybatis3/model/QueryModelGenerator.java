...
public class QueryModelGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String  rootClass = properties.getProperty(PropertyRegistry.QUERY_ROOT_CLASS);
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            Field field = getJavaQueryBeansField(introspectedColumn, context, introspectedTable);
        ...
        /**
         * 此处仍用modelBaseRecordClassGenerated 用于生成插件相关
         */
        List<CompilationUnit> answer = new ArrayList<CompilationUnit>();
       if (context.getPlugins().modelQueryModelClassGenerated(
