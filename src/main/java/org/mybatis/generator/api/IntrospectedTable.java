...
public abstract class IntrospectedTable {
    ...
    public void initializeQueryModel() {
    ...
    protected String calculateJavaQueryModelPackage() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable.getSubPackageForQueryModel(isSubPackagesEnabled(config)));
    ...
    public abstract void calculateQueryModelGenerators(List<String> warnings,
                                             ProgressCallback progressCallback);
     ...
     */
    public abstract List<GeneratedJavaFile> getQueryModelGeneratedJavaFiles();
