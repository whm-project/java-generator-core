...
//        } else {
//            javaQueryModelGeneratorConfiguration.validate(errors, id);
//        }
    ...
    public XmlElement toXmlElement() {
        ...
        if (javaQueryModelGeneratorConfiguration != null) {
            xmlElement.addElement(javaQueryModelGeneratorConfiguration
                    .toXmlElement());
        }
        ...
        if (javaControllerGeneratorConfiguration != null) {
            xmlElement.addElement(javaControllerGeneratorConfiguration
                    .toXmlElement());
        }
        if (javaServiceGeneratorConfiguration != null) {
            xmlElement.addElement(javaServiceGeneratorConfiguration
                    .toXmlElement());
        }
        if (javaServiceImplGeneratorConfiguration != null) {
            xmlElement.addElement(javaServiceImplGeneratorConfiguration
                    .toXmlElement());
        }
    ...
    public void generateFiles(ProgressCallback callback,
        ...
        if (introspectedTables != null && this.getJavaQueryModelGeneratorConfiguration() != null) {
            for (IntrospectedTable introspectedTable : introspectedTables) {
                callback.checkCancel();
                introspectedTable.initializeQueryModel();
                introspectedTable.calculateQueryModelGenerators(warnings, callback);
                generatedJavaFiles.addAll(introspectedTable.getQueryModelGeneratedJavaFiles());
                generatedJavaFiles.addAll(pluginAggregator
                        .contextGenerateAdditionalJavaFiles(introspectedTable));
            }
        }
